...
* The original package name 'iuh.edu.vn.user-service' is invalid and this project uses 'iuh.edu.vn.user_service' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.14-SNAPSHOT/reference/messaging/kafka.html)
